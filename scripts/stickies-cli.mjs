...
const LOCAL_KEY  = process.env.STICKIES_API_KEY || "";
const PROD_KEY   = process.env.STICKIES_PROD_KEY || process.env.STICKIES_API_KEY || "";

if (!LOCAL_KEY && !PROD_KEY) {
    console.error("Set STICKIES_API_KEY in env");
    process.exit(1);
}
