...
import { gotoFolderGrid } from "./nav-helpers";
...
async function openGlobalSettings(page: Page) {
    // Global Settings (with the Theme section) lives on the ROOT grid header; the
    // gear inside "All"/a folder opens folder-scoped settings instead.
